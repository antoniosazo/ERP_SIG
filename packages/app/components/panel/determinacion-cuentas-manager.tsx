...
const FILAS: { contexto: DeterminacionContexto; rol: DeterminacionRol; label: string; ayuda: string }[] = [
  ...
  { contexto: "venta", rol: "costo_venta", label: "Costo de venta (general)", ayuda: "Cuenta de resultado del asiento de costo al vender inventario." },
  ...
  { contexto: "compra", rol: "inventario", label: "Existencias (general)", ayuda: "Cuenta de existencias: cargo en la Entrada de Mercadería y haber del costo de venta." },
